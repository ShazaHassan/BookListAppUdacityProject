...
public final class QueryUtils {
    ...
    public static List<Book> fetchBooks(String requestUrl){
        ...
        try {
            ...
            Log.e("the HTTP request.", e.getLocalizedMessage());
        }

        // Extract relevant fields from the JSON response and create a list of {@link Earthquake}s
        List<Book> earthquakes = extractBookFromJson(jsonResponse);
    ...
    private static List<Book> extractBookFromJson(String bookJson){
        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                String uri = volumeInfo.getString("infoLink");
                Book book = new Book(title,author,uri);
                books.add(book);
            }
    ...
    private static URL createUrl(String stringUrl) {
        ...
        try {
            ...
            Log.e("Problem building theURL", e.getLocalizedMessage());
        }
        return url;
    }
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            Log.e("JSON results.", e.getLocalizedMessage());
        } finally {
